...
{
    public class GlobalEventManager15LB
    {
        private static GlobalEventManager15LB _instance;
        ...
        public static GlobalEventManager15LB Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GlobalEventManager15LB();
                }
                return _instance;
            }
        }
        ...
        private GlobalEventManager15LB()
        {
        ...
        public void Shutdown()
        {
            ...
            _eventQueue.Dispose();
            _logger.LogInformation("Event manager shutdown completed");
        }
    }
}